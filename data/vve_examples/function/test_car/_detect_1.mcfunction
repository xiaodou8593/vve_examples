#vve_examples:test_car/_detect_1
...
execute at @s positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,dy=0,dz=0,tag=vve_cube_box,tag=vve_material_box] run function vve_examples:test_car/detect_point