#vve_examples:test_car/_detect_8
...
execute at @s positioned ~-4.0 ~-4.0 ~-4.0 as @e[dx=7,dy=7,dz=7,tag=vve_cube_box,tag=vve_material_box] run function vve_examples:test_car/detect_point