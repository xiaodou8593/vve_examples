#vve_examples:test_car/_detect_16_c
# 使用尺寸为16的盒子探测cube实例并进行介质探测
# 输出介质响应(各模块的临时对象)
# 需要传入世界实体为执行者
...
execute at @s positioned ~-8.0 ~-8.0 ~-8.0 as @e[dx=15,dy=15,dz=15,tag=vve_cube_box,tag=vve_material_box] run function vve_examples:test_car/detect_point_c