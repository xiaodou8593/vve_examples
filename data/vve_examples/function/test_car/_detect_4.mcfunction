#vve_examples:test_car/_detect_4
...
execute at @s positioned ~-2.0 ~-2.0 ~-2.0 as @e[dx=3,dy=3,dz=3,tag=vve_cube_box,tag=vve_material_box] run function vve_examples:test_car/detect_point