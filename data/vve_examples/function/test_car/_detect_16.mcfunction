#vve_examples:test_car/_detect_16
...
execute at @s positioned ~-8.0 ~-8.0 ~-8.0 as @e[dx=15,dy=15,dz=15,tag=vve_cube_box,tag=vve_material_box] run function vve_examples:test_car/detect_point