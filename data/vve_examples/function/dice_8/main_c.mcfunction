#vve_examples:dice_8/main_c
# vve_examples:dice_8/tick调用
# 实体对象主程序
...
# 介质探测
execute as 0-0-0-0-0 run function vve_examples:dice_8/_iter_cpoints_c
# 力学迭代
...
execute if score grab_layer_response int matches 3.. if score grab_layer_receiver_v_norm int < grab_layer_regular_v int as 0-0-0-0-0 run function vve_examples:dice_8/_regular
# 运动同步
function vve:object/_sync_motion
function vve_examples:dice_8/_store
