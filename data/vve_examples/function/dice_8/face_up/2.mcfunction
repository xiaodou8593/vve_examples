...
scoreboard players set uvec_y int 5773
...
# 首先朝向0
scoreboard players set quat_phi int 450000
...
execute as @e[tag=result,limit=1] run function vve_examples:dice_8/face_up/tag