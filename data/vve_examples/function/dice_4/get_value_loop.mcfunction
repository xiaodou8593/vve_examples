#vve_examples:dice_4/get_value_loop
# vve_examples:dice_4/_get_value调用
...
execute if score fvec_z int > temp_max int store result score res int run data get storage vve_examples:io temp_values[0]
scoreboard players operation temp_max int > fvec_z int
