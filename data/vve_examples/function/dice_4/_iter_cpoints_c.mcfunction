#vve_examples:dice_4/_iter_cpoints_c
# 遍历四个顶点作为碰撞点，进行介质探测
# 输出介质响应(各模块的临时对象)
...
execute store result score sstemp_kx int store result score sstemp_ky int run scoreboard players operation sstemp_kz int /= 2955 int
...
scoreboard players operation c_vy int -= vy int
scoreboard players operation c_vz int -= vz int
scoreboard players operation c_x int /= -3 int
scoreboard players operation c_y int /= -3 int
scoreboard players operation c_z int /= -3 int
scoreboard players operation c_vx int /= -3 int
scoreboard players operation c_vy int /= -3 int
scoreboard players operation c_vz int /= -3 int
scoreboard players operation c_x int += x int
scoreboard players operation c_y int += y int
scoreboard players operation c_z int += z int
scoreboard players operation c_vx int += vx int
...
scoreboard players operation sstemp_kx int *= -3 int
scoreboard players operation sstemp_ky int *= -3 int
scoreboard players operation sstemp_kz int *= -3 int
scoreboard players operation sstemp_tx int *= -3 int
scoreboard players operation sstemp_ty int *= -3 int
scoreboard players operation sstemp_tz int *= -3 int
