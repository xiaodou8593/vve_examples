...
function vve_examples:dice_4/_proj
...
scoreboard players set uvec_y int 3333
scoreboard players set uvec_z int -9428
# 竖直朝上向量
...
# 首先朝向0
scoreboard players set quat_phi int 900000
...
# 取消物理运动,存储数据
scoreboard players set point dice_dpoint 2
execute as @e[tag=result,limit=1] run function vve_examples:dice_4/face_up/tag