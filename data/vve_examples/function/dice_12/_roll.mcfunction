...
execute as @e[tag=result,limit=1] run function vve_examples:dice_12/_get

function vve_examples:dice_12/_rand_quat
...
execute as @e[tag=result,limit=1] run function vve_examples:dice_12/_store

# 设置销毁事件
execute as @e[tag=result,limit=1] run function marker_control:data/_get
data modify storage marker_control:io result.del_func set value "vve_examples:dice_12/_print_value_as"
