#vve_examples:dice_12/regular/surface_9
...
execute store result storage math:io xyz[0] double 0.0001 run scoreboard players operation sstemp_n9_x int += u int
execute store result storage math:io xyz[1] double 0.0001 run scoreboard players operation sstemp_n9_y int += v int
execute store result storage math:io xyz[2] double 0.0001 run scoreboard players operation sstemp_n9_z int += w int
