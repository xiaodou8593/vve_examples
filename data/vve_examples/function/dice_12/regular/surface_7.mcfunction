#vve_examples:dice_12/regular/surface_7
...
execute store result storage math:io xyz[0] double 0.0001 run scoreboard players operation sstemp_n7_x int += u int
execute store result storage math:io xyz[1] double 0.0001 run scoreboard players operation sstemp_n7_y int += v int
execute store result storage math:io xyz[2] double 0.0001 run scoreboard players operation sstemp_n7_z int += w int
