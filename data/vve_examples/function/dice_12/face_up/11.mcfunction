...
scoreboard players set uvec_x int 5257
scoreboard players set uvec_y int 0
scoreboard players set uvec_z int 8506
# 竖直朝上向量
...
# 首先朝向0
scoreboard players set quat_phi int 660000
...
# 取消物理运动,存储数据
scoreboard players set point dice_dpoint 11
