#vve_examples:dice_12/face_up/{n}
...
scoreboard players set uvec_x int -8506
scoreboard players set uvec_y int -5257
...
# 首先朝向0
scoreboard players set quat_phi int 630000
...
# 取消物理运动,存储数据
scoreboard players set point dice_dpoint 10
